...
module.exports = (express, connection) => {
  ...
  const MenuPriceController = require('./controllers/menuPrice.controller')(
    connection,
    resSQL_err
  )
  const MenuSizeController = require('./controllers/menuSize.controller')(
    connection,
    resSQL_err
  )
  ...
  const StaffPostionController = require('./controllers/staffPosition.controller')(
    connection,
    resSQL_err
  )
  ...
  router.group('/bill', billRouter => {
    ...
    billRouter.route('/:id/total').get(BillController.billtotal)
