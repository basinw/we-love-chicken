...
class IndexComponent extends React.Component {
  ...
  render() {
    return (
      <div>
        <CategoryBar
          cats={this.state.categorys}
          selCat={this.state.selectedCat}
          onClickCat={this.selectCat}
        />
            ...
            <div className="col-3">
              <OrderList>
                {this.state.selectedList.length === 0 ? (
                  ...
                  <FillOrderList
                    cartList={this.state.selectedList}
                    editQ={this.editQuantity}
                  />
                )}
                <OrderGroupBtn>
                  <button
                  ...
                  <Link to={`/orderlist`} className="btn btn-danger btn-block">
                    ดูรายการที่สั่ง
                  </Link>
                </OrderGroupBtn>
              </OrderList>
